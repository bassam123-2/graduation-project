"""
Simplified Django settings for development integration testing.
"""
...
SECRET_KEY = 'django-insecure-ob89q=ms+99(ix$p#y+5zz*pf#-r7jc0m87on^$5$3@i*l7hj5'
...
CORS_ORIGIN_ALLOW_ALL = True  # Alternative setting
...
# CSRF Exemption for specific views (development only)
CSRF_EXEMPT_URLS = [
    '/api/users/login/',
    '/api/users/register/',
...
# Email Configuration - Using real Gmail SMTP
...
EMAIL_VERIFICATION_REQUIRED = True  # Re-enabled
