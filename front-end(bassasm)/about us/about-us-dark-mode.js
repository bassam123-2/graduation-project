// Professional Dark Mode and Interactive Features for AL-BOQAI Center About Us Pages
...
function initializeInteractiveFeatures() {
    ...
    const interactiveElements = document.querySelectorAll('.profile-section, .target-section, .info-card, .image-container, .benefit-item, .technique-card, .element-card, .component-card');
    ...
    const images = document.querySelectorAll('.about-image, .profile-section img');
    images.forEach(img => {
...
function initializeAnimations() {
    ...
    const animateElements = document.querySelectorAll('.profile-section, .target-section, .info-card, .service-intro, .techniques-section, .benefits-section, .session-info');
    ...
    const listItems = document.querySelectorAll('.target-list li, .benefit-item, .technique-card, .element-card');
...
console.log('%cWelcome to AL-BOQAI Center About Us! 🏥', 'color: #2a5d9f; font-size: 18px; font-weight: bold;');
